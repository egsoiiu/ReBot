...
async def start_command(client, message):
    await message.reply_text(
        ...
        "• /instant_change_thumb - Instantly change thumbnail of replied video using your saved thumbnail"
    )

# ========== INSTANT CHANGE THUMBNAIL COMMAND ==========
...
async def instant_change_thumb(client, message: Message):
    if not message.reply_to_message or not message.reply_to_message.video:
        await message.reply_text("❌ Please reply to a video message with /instant_change_thumb command.")
        return

    user_id = message.from_user.id
    video_file_id = message.reply_to_message.video.file_id
    video_duration = message.reply_to_message.video.duration

    thumb_file_id = await db.get_thumbnail(user_id)
    if not thumb_file_id:
        await message.reply_text("❌ You don't have a custom thumbnail set. Send a photo first to set your thumbnail.")
        return
    ...
    try:
        ...
        await client.send_video(
            ...
            video=video_file_id,
            thumb=thumb_path,
            caption="🎥 Thumbnail changed instantly using your saved custom thumbnail!",
        ...
        await message.reply_text(f"❌ Error changing thumbnail: {e}")
